...
public class ThreeMusketeers {
    ...
    protected void move(final Agent agent) { // TODO
        ...
        if (move == null) {
            System.out.println("[ERROR] No valid move has been made yet!");
            return;
        }
        
        // new move 
        Move moveCopy = new Move(
        		board.getCell(move.fromCell.getCoordinate()),
        		board.getCell(move.toCell.getCoordinate())
        );
        
        // for undo/redo stack
        // saving the move in the moves list
        moves.add(moveCopy);
    ...
    private void undoMove() { // TODO
        ...
        if (!moves.isEmpty()) {
            ...
            System.out.println("[Undoing move: " + prevMove + "]");
...
//    	String boardFileName = "Boards/isValidMove_complex_board_states2.txt";
//    	String boardFileName = "Boards/getPossibleCells_basic_valid_moves.txt.txt";
